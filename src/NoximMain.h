...
#define SET_SENT_PACKET_NUMBER  1000
...
// packet state
#define STATE_SENT             0
#define STATE_NOT_SENT         1
#define STATE_SUCCESS          2
#define STATE_NO_PATH          3
...
#define ROUTING_NEGATIVE_FIRST_FAULT_TOLERANCE 10
...
#define DEFAULT_BUFFER_DEPTH                              100000
#define DEFAULT_MAX_PACKET_SIZE                           2
#define DEFAULT_MIN_PACKET_SIZE                            2
#define DEFAULT_ROUTING_ALGORITHM                 ROUTING_NEGATIVE_FIRST_FAULT_TOLERANCE
#define DEFAULT_ROUTING_TABLE_FILENAME                    ""
#define DEFAULT_SELECTION_STRATEGY                 FIX//SEL_RANDOM//SEL_RANDOM FIX
#define DEFAULT_PACKET_INJECTION_RATE                   0.0001
#define DEFAULT_PROBABILITY_OF_RETRANSMISSION           0
...
extern vector < int > FaultRouter;
extern int SentPacketNumber;
extern int PackedIndex;
extern vector < int > PacketState;
//extern vector < int > PacketPath;
